...
export function DesktopSidebar() {
    ...
    return (
        <div
            className="hidden lg:flex flex-col h-screen w-64 border-r border-primary/10 bg-background/80 backdrop-blur-md fixed left-0 top-0 z-30 p-4">
                    ...
                    return (
                        ...
                        >
                            ...
                            {item.name === "Notifications" && (
                                <span
                                    className="ml-auto flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-pink-500 to-orange-500 text-[10px] text-white">
                  5
                </span>
                            )}
                        </Link>
