...
export function SettingsPage() {
    ...
    const userData = user
        ? {
            ...
            avatar: user.profilePictureUrl || "/placeholder.svg?height=100&width=100",
        }
        : {
            name: "Mahmudul Hasan",
            username: "mahmudx",
                                ...
                                <div className="flex-1 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea id="bio" defaultValue={userData.bio}
                                                  className="border-primary/20 resize-none" rows={3}/>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                >
                                    <CardContent className="p-4 flex flex-col items-center">
                                        <div
                                            className="h-24 w-full bg-[#FFFFFF] rounded-lg mb-2 flex items-center justify-center">
                                ...
                                >
                                    <CardContent className="p-4 flex flex-col items-center">
                                        <div
                                            className="h-24 w-full bg-[#1F1F1F] rounded-lg mb-2 flex items-center justify-center">
                                ...
                                >
                                    <CardContent className="p-4 flex flex-col items-center">
                                        <div
                                            className="h-24 w-full bg-gradient-to-r from-[#FFFFFF] to-[#1F1F1F] rounded-lg mb-2 flex items-center justify-center">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="space-y-0.5">
                                    ...
                                    <p className="text-sm text-muted-foreground">Increase contrast for better
                                        visibility</p>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive emails when someone
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive emails when someone likes
                                            your posts</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive emails when someone follows
                                            you</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive emails for new direct
                                            messages</p>
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive push notifications for all
                                            activity</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive push notifications when
                                            you're mentioned</p>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <p className="text-sm text-muted-foreground">Receive push notifications for new
                                            direct messages</p>
                                    </div>
