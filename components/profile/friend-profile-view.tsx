...
export function FriendProfileView({ username }: FriendProfileViewProps) {
  ...
  const userData = {
    ...
    bio: "Wildlife photographer and nature enthusiast. Capturing the beauty of our planet one frame at a time. ✨🌍📸",
  ...
  const posts = [
    ...
    },
    {
      id: "post3",
      content:
        "Morning hike at Mount Tamalpais. The fog rolling over the hills created such a mystical atmosphere.",
      image: "/placeholder.svg?height=400&width=600",
      likes: 156,
      comments: 24,
  ...
  const aboutData = {
    ...
    places: [
      { name: "San Francisco, CA", type: "Current City", since: "2018" },
      { name: "Portland, OR", type: "Hometown", since: "Born" },
    ],
    contactInfo: {
      email: "public.email@example.com",
      website: "emmawilson.com",
      social: {
        instagram: "@emma.captures",
        twitter: "@emmawilson_photo",
      },
    },
  };
              ...
              <div className="lg:mb-4">
                <div className="flex items-center">
                  ...
                  {userData.isVerified && (
                    <Badge
                      variant="outline"
                      className="ml-2 bg-blue-500 text-white border-none"
                    >
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center text-sm">
                    ...
                    <span>Photographer at {aboutData.work[0].company}</span>
                  </div>
                  <div className="flex items-center text-sm">
            ...
            <Card className="rounded-xl border-primary/20 overflow-hidden bg-background/60 backdrop-blur-sm">
              <CardContent className="p-4">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  {userData.stats.friends} friends
                </p>
                    ...
                    >
                      <div className="space-y-1">
                        <div className="relative aspect-square rounded-lg overflow-hidden">
                          <Image
                            src={`/placeholder.svg?height=80&width=80&text=Friend+${
                              i + 1
                            }`}
                            alt={`Friend ${i + 1}`}
                            fill
              ...
              <Card className="rounded-xl border-primary/20 overflow-hidden bg-background/60 backdrop-blur-sm">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h4 className="font-medium text-lg mb-3 flex items-center">
                        <Icons.contact className="mr-2 h-5 w-5" />
                        Contact Info
                      </h4>
                      <div className="space-y-4">
                        <div className="flex">
                        ...
                        <div className="flex">
                          ...
                          <div>
                            <p className="font-medium">
                              {aboutData.contactInfo.social.instagram}
                            </p>
                            <p className="text-sm text-muted-foreground">
                              Instagram
                            </p>
                        ...
                        <div className="flex">
                          ...
                          <div>
                            <p className="font-medium">
                              {aboutData.contactInfo.social.twitter}
                            </p>
                            <p className="text-sm text-muted-foreground">
                              Twitter
                            </p>
                      ...
                      >
                        <div className="rounded-xl border border-primary/10 p-3 hover:border-primary/20 hover:shadow-sm transition-all">
                          <div className="relative h-32 rounded-lg overflow-hidden mb-2">
                            <Image
                              src={`/placeholder.svg?height=150&width=150&text=Friend+${
                                i + 1
                              }`}
                              alt={`Friend ${i + 1}`}
                              fill
